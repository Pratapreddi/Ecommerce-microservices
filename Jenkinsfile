                ...
                withCredentials([
                    ...
                    sh '''
                        ...
                        kubectl set image deployment/products-service \
                          products-service=$ECR_REGISTRY/products-service:${BUILD_NUMBER}
                        kubectl set image deployment/orders-service \
                          orders-service=$ECR_REGISTRY/orders-service:${BUILD_NUMBER}
                        kubectl set image deployment/api-gateway \
                          api-gateway=$ECR_REGISTRY/api-gateway:${BUILD_NUMBER}
